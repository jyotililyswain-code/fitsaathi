...
export default function CoachDirectory({ includeDojos = false }: { includeDojos?: boolean }) {
        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              {includeDojos ? "Search coaches, dojos and gyms" : "Search and filter fitness coaches"}
            </h2>
