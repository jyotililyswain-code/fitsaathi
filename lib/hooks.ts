...
export function useCoach(id: string, initial: Coach | null = null) { return useAsync<Coach | null>(() => getCoach(id), initial, id); }
...
export function useDojo(id: string, initial: Dojo | null = null) { return useAsync<Dojo | null>(() => getDojo(id), initial, id); }
...
export function useProduct(id: string, initial: Product | null = null) { return useAsync<Product | null>(() => getProduct(id), initial, id); }
