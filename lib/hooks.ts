...
import { getBookings, getCoach, getCoaches, getCollectionCount, getDojo, getDojos, getFeaturedCoaches, getFeaturedDojos, getPlatformStats, getProduct, getProducts, getProviderBookings, getReviews, getSellers, getUserBookings } from "@/lib/data";
...
export function useDojos(featured = false) { return useAsync<Dojo[]>(featured ? getFeaturedDojos : getDojos, [], featured); }
