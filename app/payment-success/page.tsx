  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-xl items-center px-4 py-12">
      <section className="rounded-2xl border border-acid/30 bg-acid/10 p-6">
        ...
        <p className="mt-3 leading-7 text-zinc-300">Your transaction has been recorded. Booking, dojo registration, or payout status will update from the matching payment record.</p>
