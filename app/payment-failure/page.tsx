  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-xl items-center px-4 py-12">
      <section className="rounded-2xl border border-red-400/30 bg-red-400/10 p-6">
        ...
        <h1 className="mt-4 text-3xl font-bold text-white">Payment not submitted</h1>
        <p className="mt-3 leading-7 text-zinc-300">No booking or order will be confirmed until a valid UPI transaction ID is submitted and verified by an administrator.</p>
