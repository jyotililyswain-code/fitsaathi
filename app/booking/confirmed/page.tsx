  ...
  return (
    <main className="mx-auto flex min-h-[70vh] max-w-2xl items-center px-4 py-12">
      <section className="w-full rounded-2xl border border-acid/30 bg-acid/10 p-6 sm:p-8">
        ...
        <p className="mt-3 leading-7 text-zinc-300">FitSaathi charged ₹0. There is no payment step, platform fee, or hidden booking charge. The provider can now accept your requested session.</p>
