...
import { BadgeCheck, BarChart3, FileWarning, MessageSquare, ShieldAlert } from "lucide-react";
...
export default function SocialAdminPage() {
  ...
  const load = useCallback(async () => {
    try {
      const [overview, verifications, moderation, reports, conversations, analytics] = await Promise.all([
        ...
        socialApi<Analytics>("/admin/analytics")
      ]);
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <Panel title="Community activity">
            <div className="grid gap-3 text-sm text-zinc-300">
              ...
              <Row title="Invites sent" meta="30 days" value={analytics?.invites ?? "..."} />
              <Row title="Invites accepted" meta="30 days" value={analytics?.acceptedInvites ?? "..."} />
              <Row title="30-day messages" meta="Analytics" value={analytics?.messages ?? "..."} />
              <Row title="Profile views" meta="30 days" value={analytics?.profileViews ?? "..."} />
              <Row title="Safety reports" meta="30 days" value={analytics?.reports ?? "..."} />
            </div>
          </Panel>
        </section>
      </main>
