...
const features = [
  {
    ...
    body: "Create your verified TheFitSaathi profile and choose your interests.",
    href: "/signup",
    icon: UserPlus
  },
  {
  ...
  },
  {
    ...
    body: "Use TheFitSaathi Life to discover training partners with shared goals.",
    href: "/life",
    icon: UsersRound
  },
  {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <section className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-acid/10 via-white/[.04] to-royal/10 p-8 sm:p-12">
        ...
        <h1 className="mt-3 max-w-3xl text-4xl font-black text-white sm:text-6xl">What do you want to do on TheFitSaathi?</h1>
