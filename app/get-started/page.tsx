import { ArrowRight, CalendarCheck, Dumbbell, Handshake, Search, ShoppingBag, Sparkles, Store, UserPlus, UsersRound } from "lucide-react";
import Link from "next/link";

const features = [
  {
    title: "Guided Welcome",
    body: "Choose your interests and see a short introduction to FitSaathi.",
